...
def train(args):
    ...
    #     shuffle=True,
    # )
    train_dataloaders = [BatchDataLoader(
    ...
    train_dataloaders = [accelerator.prepare_data_loader(train_dataloader) for train_dataloader in train_dataloaders]
    ...
    while True:
        train_dataloader_iteration = epoch % len(train_dataloaders)
        train_dataloader = train_dataloaders[train_dataloader_iteration]
        print('Train dataloader iteration:', train_dataloader_iteration)
        model.train()
...
def main():
    ...
    parser.add_argument('--train_data_path', type=str, required=True, action='append')
